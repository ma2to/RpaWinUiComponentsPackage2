...
namespace RpaWinUiComponentsPackage.AdvancedWinUiDataGrid.Models.Configuration;
...
public class DataGridColorConfig
{
    ...
    public static DataGridColorConfig Default => new()
    {
        ...
        OddRowBackgroundColor = Color.FromArgb(255, 249, 249, 249), // Very light gray
